...
handoffs:
  - label: Passer à l'étape Refactor
    ...
    prompt: Le code de production minimal dans les fichiers de test est maintenant écrit. Refactor le code dans les fichiers de production tout en gardant les tests verts.
    send: false
---
...
```json
{
  "test_file_path": "tests/application/test_place_order.py",
  "test_method_name": "test_commande_simple_mojito_en_stock_cree_commande_en_attente_avec_id",
  "implemented_code": [ "FakeInventoryRepository", "FakeOrderRepository", "Order" ]
}
```